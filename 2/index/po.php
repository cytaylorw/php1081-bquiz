<div>目前位置：首頁 > 分類網誌 > <span class="navtype">健康新知</span> </div>
<fieldset style="display:inline-block;width:20%">
    <legend>網誌分類</legend>
    <ul class="ul-list">
        <li class="types">健康新知</li>
        <li class="types">菸害防治</li>
        <li class="types">癌症防治</li>
        <li class="types">慢性病防治</li>
    </ul>
</fieldset>
<fieldset style="display:inline-block;width:70%;vertical-align:top;">
    <legend>文章列表</legend>
    <div class="list">
        <ul class="ul-list" data-type="0">
            <li>國人無規律運動之比率高達72.2%(一)</li>
            <li>國人無規律運動之比率高達72.2%(二)</li>
        </ul>
    </div>
    <div class="list" style="display:none">
        <ul class="ul-list" data-type="1">
            <li>菸害防治法規(一)</li>
            <li>菸害防治法規(二)</li>
        </ul>
    </div>
    <div class="list" style="display:none">
        <ul class="ul-list" data-type="2">
            <li>降低罹癌風險(一)</li>
            <li>降低罹癌風險(二)</li>
        </ul>
    </div>
    <div class="list" style="display:none">
        <ul class="ul-list" data-type="3">
            <li>長期憋尿 泌尿系統問題多(一)</li>
            <li>長期憋尿 泌尿系統問題多(二)</li>
        </ul>
    </div>
