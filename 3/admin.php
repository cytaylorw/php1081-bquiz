...
<body>
    <div id="main">
        ...
        <div id="top2"> <a href="index.php">首頁</a> <a href="index.php?do=ord">線上訂票</a> <a href="#">會員系統</a> <a href="index.php?do=admin">管理系統</a> </div>
        ...
        <div id="mm">
            <div class="ct a rb" style="position:relative; width:101.5%; left:-1%; padding:3px; top:-9px;"> <a
                    href="?do=tit">網站標題管理</a>| <a href="?do=go">動態文字管理</a>| <a
                    href="?do=post">預告片海報管理</a>| <a href="?do=mv">院線片管理</a>| <a
                    href="?do=ord">電影訂票管理</a> </div>
            <div class="rb tab">
                <?php
